    ...
    public partial class initDB1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonMark", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LessonMark_Lesson_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lesson",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LessonMark_Mark_MarkId",
                        column: x => x.MarkId,
                        principalTable: "Mark",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LessonMark_Student_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Student",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonMark_LessonId",
                table: "LessonMark",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_LessonMark_MarkId",
                table: "LessonMark",
                column: "MarkId");

            migrationBuilder.CreateIndex(
                name: "IX_LessonMark_StudentId",
                table: "LessonMark",
                column: "StudentId");
